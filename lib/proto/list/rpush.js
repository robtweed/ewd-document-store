...
module.exports = function(obj) {
  ...
  if (isNew) {
    ...
    let lastNodeDoc = listNode.$('lastNode');
    let previousLast = lastNodeDoc.value;
    lastNodeDoc.value = ix;
    newNodeDoc.$('previousNode').value = previousLast;
    nodeDoc.$([previousLast, 'nextNode']).value = ix;
  }
  return ix;
};
